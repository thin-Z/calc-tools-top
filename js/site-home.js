...
const SITE_CONFIG = {
    ...
    /* __GENERATED_SITE_CONFIG_TOOLS_START__ */
        ...
        { id: 'badge-maker', categories: ["image"] },
...
const TOOLS_DATA = {
    ...
    'badge-maker': { icon: 'image', name: { zh: '吧唧制作', en: 'Badge Maker' }, desc: { zh: '上传图片裁剪成圆形吧唧，拟真预览，300 DPI 打印稿支持 A4 拼版', en: 'Crop photos into round badges, realistic preview, 300 DPI A4 print sheet' } },
...
const TOOL_KEYWORDS_ZH = {
    ...
    'badge-maker': '吧唧制作,吧唧,马口铁徽章,徽章制作,吧唧打印,badge',
